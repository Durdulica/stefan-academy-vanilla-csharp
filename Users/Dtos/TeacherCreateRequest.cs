...
namespace stefan_academy_vanilla_charp.Users.Dtos
{
    public class TeacherCreateRequest : UserCreateRequest
    {
        ...
        public TeacherCreateRequest() : base() { }
        
        public TeacherCreateRequest(string firstName, string lastName, string email, int age, int salary, int workHours, string password)
